...
<body>
    ...
    <form action="" method="post">
	    <h3> <span> 标&nbsp;&nbsp;&nbsp;&nbsp;题：</span><input type="text" name="bti" cols="60" style="WIDTH: 380px"></></h3>
        <h3><span>关键字：</span><input type="text" name="bti2" cols="60" style="WIDTH: 380px"></></h3>
        <h3><span></span><?php include('kuang2.php');?></h3>
